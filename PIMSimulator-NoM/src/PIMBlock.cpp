...
std::string PIMBlock::print()
{
    ...
    for (int i = 0; i < 16; i++) ss << "[GRF_A][" << i << "]" << grfA[i].fp16ToStr() << endl;
    for (int i = 0; i < 16; i++) ss << "[GRF_B][" << i << "]" << grfB[i].fp16ToStr() << endl;
    for (int i = 0; i < 16; i++) ss << "[GRF_C][" << i << "]" << grfC[i].fp16ToStr() << endl;
